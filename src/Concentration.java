...
public class Concentration extends FlexiblePictureExplorer implements
	...
	// You can modify this to include your own pictures
	public static void main(String[] args) {
		String basePath = "Z:/Computer Science A AP_ Ms.Gerb/Java Projects/PictureProject/Pictures/Presidents/"; 
	
	
		Picture[] pictures = new Picture[] {
				new Picture(basePath + "Abraham Lincoln.jpg"),
				new Picture(basePath + "Bill Clinton.jpg"),
				new Picture(basePath + "Georgey.jpg"),
				new Picture(basePath + "george-bush.jpg"),
				new Picture(basePath + "Kennedy.jpg"),
				new Picture(basePath + "obama-kids.jpg"),
				new Picture(basePath + "Ronald-Reagan-012.jpg"),
				new Picture(basePath + "newTrump.jpg") };
		Picture coverPic = new Picture(basePath+"koala.jpg");
		new Concentration(pictures, coverPic, 700, 700, 2, 6);
	}
}